...
//         <form onSubmit={handleSubmit} style={{ width: '100%' }}>
//           <div className="form-group mb-3">
//             <label htmlFor="email" className="text-center d-block text-white">Login with Email ID</label>
//             <input
//               type="text"
//               value={email}
//               id="email"
...
//             />
//             {clientErrors.email && (
//               <span className="text-danger d-block text-center mt-2">{clientErrors.email}</span>
//             )}
//           </div>
...
//             fontWeight: 'bold',
//           }}>
//             {loading ? <span className="spinner-border spinner-border-sm me-2" /> : 'Log In'}
//           </button>
//         </form>
//       </div>
//     </div>
